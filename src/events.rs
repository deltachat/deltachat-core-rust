...
pub enum EventType {
    ...
    #[strum(props(id = "2060"))]
    SecurejoinInviterProgress { contact_id: i64, progress: usize },
    ...
    #[strum(props(id = "2061"))]
    SecurejoinJoinerProgress { contact_id: i64, progress: usize },
}
