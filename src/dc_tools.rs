...
/// Determine whether to use RFC724 or legacy msgid prefixes.
pub(crate) fn use_rfc724_msgid_prefix(context: &Context) -> bool {
    match context.get_config(Config::Rfc724MsgIdPrefix) {
...
pub(crate) fn dc_create_outgoing_rfc724_mid(
    grpid: Option<&str>,
    from_addr: &str,
    use_rfc724_msgid_prefix: bool,
) -> String {
