...
extern "C" {
    ...
    #[no_mangle]
    fn mailsmtp_socket_connect(
        session: *mut mailsmtp,
        server: *const libc::c_char,
        port: uint16_t,
    ) -> libc::c_int;
    #[no_mangle]
    fn mailsmtp_socket_starttls(session: *mut mailsmtp) -> libc::c_int;
    #[no_mangle]
    fn mailsmtp_ssl_connect(
        session: *mut mailsmtp,
        server: *const libc::c_char,
        port: uint16_t,
    ) -> libc::c_int;
    #[no_mangle]
    fn mailsmtp_oauth2_authenticate(
        session: *mut mailsmtp,
    ...
    #[no_mangle]
    fn mailsmtp_free(session: *mut mailsmtp);
    #[no_mangle]
    fn mailsmtp_set_timeout(session: *mut mailsmtp, timeout: time_t);
    #[no_mangle]
    fn mailsmtp_auth(
        session: *mut mailsmtp,
    ...
    #[no_mangle]
    fn mailsmtp_helo(session: *mut mailsmtp) -> libc::c_int;
    #[no_mangle]
    fn mailsmtp_mail(session: *mut mailsmtp, from: *const libc::c_char) -> libc::c_int;
    #[no_mangle]
    fn mailsmtp_rcpt(session: *mut mailsmtp, to: *const libc::c_char) -> libc::c_int;
    #[no_mangle]
    fn mailsmtp_data(session: *mut mailsmtp) -> libc::c_int;
    #[no_mangle]
    fn mailsmtp_data_message(
        session: *mut mailsmtp,
        message: *const libc::c_char,
        size: size_t,
    ) -> libc::c_int;
    #[no_mangle]
    fn mailesmtp_ehlo(session: *mut mailsmtp) -> libc::c_int;
    #[no_mangle]
    fn mailesmtp_mail(
        session: *mut mailsmtp,
    ...
    #[no_mangle]
    fn mailsmtp_strerror(errnum: libc::c_int) -> *const libc::c_char;
    #[no_mangle]
    fn mailesmtp_auth_sasl(
        session: *mut mailsmtp,
    ...
    #[no_mangle]
    fn mailsmtp_set_progress_callback(
        session: *mut mailsmtp,
...
pub const MAILSMTP_AUTH_KERBEROS_V4: unnamed_0 = 256;
pub const MAILSMTP_AUTH_NTLM: unnamed_0 = 128;
pub const MAILSMTP_AUTH_SRP: unnamed_0 = 64;
pub const MAILSMTP_AUTH_GSSAPI: unnamed_0 = 32;
pub const MAILSMTP_AUTH_DIGEST_MD5: unnamed_0 = 16;
pub const MAILSMTP_AUTH_LOGIN: unnamed_0 = 8;
pub const MAILSMTP_AUTH_PLAIN: unnamed_0 = 4;
pub const MAILSMTP_AUTH_CRAM_MD5: unnamed_0 = 2;
pub const MAILSMTP_AUTH_CHECKED: unnamed_0 = 1;
pub const MAILSMTP_AUTH_NOT_CHECKED: unnamed_0 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct mailsmtp {
